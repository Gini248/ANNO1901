...
<nav class="navbar">
 ...
 <div class="detalhes_ooc">
    ...
    <p><strong>Idade OOC:</strong> <?= $candidato['idade_ooc']; ?></p>
    <p><strong>Nome OOC:</strong> <?= $candidato['nome_ooc']; ?></p>
    <p><strong>Já foi banido:</strong> <?= $candidato['banido']; ?></p>
    <p><strong>Como conheceu o server:</strong> <?= $candidato['como_conheceu']; ?></p>
    <p><strong>Motivo de Candidatura:</strong> <?= $candidato['motivo']; ?></p>
    <p><strong>Tempo de RP:</strong> <?= $candidato['tempo_rp']; ?></p>
